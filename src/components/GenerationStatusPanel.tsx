...
import { X, Eye, Clock, CheckCircle, AlertCircle, Loader2, XCircle } from 'lucide-react'

export default function GenerationStatusPanel() {
  const [isNavigating, setIsNavigating] = useState(false)
  const router = useRouter()
  const { getActiveJobs, getCompletedJobs, isGenerating, removeJob } = useGenerationStore()
